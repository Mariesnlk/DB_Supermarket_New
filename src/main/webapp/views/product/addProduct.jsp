...
<%--            <label>ID товару: </label> <input type="text" name="idProd" placeholder="Введіть ID продукту.."><br/>--%>
            <label>Назва: </label> <input type="text" name="categoryProd" placeholder="Введіть номер категорії.."><br/>
            <label>Назва: </label> <input type="text" name="nameProd" placeholder="Введіть назву продукту.."><br/>
            <label>Назва: </label> <input type="text" name="charsProd" placeholder="Введіть характеристику продукту.."><br/>
