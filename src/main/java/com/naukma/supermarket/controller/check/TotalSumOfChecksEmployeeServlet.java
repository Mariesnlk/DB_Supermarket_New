...
@WebServlet(name = "TotalSumOfChecksEmployeeServlet", urlPatterns = {"/checks-by-employee-from-period"})
public class TotalSumOfChecksEmployeeServlet extends HttpServlet {

    private final Logger LOGGER = Logger.getLogger(TotalSumOfChecksEmployeeServlet.class);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Check sumCheck = checkService.totalSumOfChecks(idEmployee,dateStart,dateFinish);
