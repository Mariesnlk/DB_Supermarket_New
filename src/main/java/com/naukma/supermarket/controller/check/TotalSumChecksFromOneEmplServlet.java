...
@WebServlet(name = "TotalSumChecksFromOneEmplServlet", urlPatterns = {"/sum-check-one-empl"})
public class TotalSumChecksFromOneEmplServlet extends HttpServlet {

    private final Logger LOGGER = Logger.getLogger(TotalSumChecksFromOneEmplServlet.class);
