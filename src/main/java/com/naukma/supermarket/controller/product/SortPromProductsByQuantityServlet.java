...
@WebServlet(name = "SortPromProductsByQuantityServlet", urlPatterns = {"/sort-prom-by-quantity"})
public class SortPromProductsByQuantityServlet extends HttpServlet {

    private final Logger LOGGER = Logger.getLogger(SortPromProductsByQuantityServlet.class);

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

        ProductService productService = new ProductServiceImpl();

        List<Product> allProducts = productService.promProductsSortedByQuantity();
