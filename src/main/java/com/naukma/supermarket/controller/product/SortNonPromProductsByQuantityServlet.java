...
@WebServlet(name = "SortNonPromProductsByQuantityServlet", urlPatterns = {"/sort-non-prom-by-quantity"})
public class SortNonPromProductsByQuantityServlet extends HttpServlet {

    private final Logger LOGGER = Logger.getLogger(SortNonPromProductsByQuantityServlet.class);

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

        ProductService productService = new ProductServiceImpl();

        List<Product> allProducts = productService.nonPromProductsSortedByQuantity();
